                ...
                <div className="mt-6">
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-2 bg-gray-800 text-indigo-300 rounded-md">O continuar con</span>
                    </div>
                  </div>
                  <Button variant="outline" className="w-full mt-4 border-purple-600 text-indigo-100 hover:bg-purple-700/50 hover:text-white" onClick={handleGoogleSignIn}>
                    <svg className="mr-2 h-5 w-5" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 381.7 512 244 512 109.8 512 0 402.2 0 261.8S109.8 11.6 244 11.6C381.7 11.6 488 120.5 488 261.8zM100.2 261.8c0 25.4 4.9 49.2 13.6 70.8l124.2-124.2V261.8H100.2zM244 500c36.5 0 70.3-7.8 99.8-21.3L238.6 354.4 176.8 419c-27.3 19.9-60.2 32.3-96.2 32.3-1.3 0-2.7-.1-4-.1 33.7 30.1 76.3 48.7 123.4 48.7zM400.9 374.8c26.7-30.4 42.5-69.3 42.5-113 0-11.3-1.1-22.4-3.2-33.2L289.6 278.6l111.3 96.2zM244 12.9c-36.5 0-70.3 7.8-99.8 21.3L250.4 158.6l61.8-64.8c27.3-19.9 60.2-32.3 96.2-32.3 1.3 0 2.7.1 4 .1-33.7-30.1-76.3-48.7-123.4-48.7z"></path></svg>
                    Google
                  </Button>
                </div>
              </CardContent>
